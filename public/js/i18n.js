...
const EN = {
  ...
  Latar: 'Background',
  'Kembalikan mengikuti tema': 'Follow the theme again',
  'Sedang mengikuti tema': 'Following the theme',
  Terang: 'Light',
  Gelap: 'Dark',
  'Ikut perangkat': 'Follow device',
  'Dapat juga diubah lewat tombol ☀ / 🌙 / ◐ di bilah atas.':
    'Can also be switched with the ☀ / 🌙 / ◐ buttons in the top bar.',
